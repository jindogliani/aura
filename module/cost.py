...
if ver == "2022":
    ...
    init_cell_variance = 87.00304490243931  # cell size 10cm
    init_regulation_variance = 3.993041804544382
    init_WCSS = 47.371773504529884

    space_heatmap = np.load('SpaceData/2022_HJW+(9-27-20-52).npy') #cell size 0.1
    space_heatmap[space_heatmap > 254] = -1000 
    space_heatmap[space_heatmap == 0] = -1000
